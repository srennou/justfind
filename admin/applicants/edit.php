...
<form class="form-horizontal span6  wow fadeInDown" action="controller.php?action=edit" method="POST">
  ...
  <div class="form-group">
    <div class="col-md-8">
      <label class="col-md-4 control-label" for="CELLNO">Conact No.:</label>

      <div class="col-md-8">

        <input class="form-control input-sm" id="CELLNO" name="CELLNO" placeholder="Conact No." type="text" any value="<?php echo $emp->CELLNO; ?>" required onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
      </div>
    </div>
  </div>
