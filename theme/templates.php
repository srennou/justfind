...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <!-- <a><img src="just.png" alt="logo" href="<?php echo web_root; ?>"> </a> -->
            <!-- class=" img-thumbnail" " -->
            <a class=" navbar-brand" href="<?php echo web_root; ?>">Just Find</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item <?php if (isset($_GET['q'])) {
                              ...
                              }  ?>"><a class="nav-link" href="<?php echo web_root; ?>index.php?q=company">Company</a>
                    </li>
                    <li class="nav-item <?php if (isset($_GET['q'])) {
                                if ($_GET['q'] == 'hiring') {
                                  echo 'active';
                              ...
                              } ?>"><a class="nav-link" href="<?php echo web_root; ?>index.php?q=hiring">Hiring Now</a>
                    </li>
                    <li class="nav-item <?php if (isset($_GET['q'])) {
                                if ($_GET['q'] == 'About') {
                                  echo 'active';
                    ...
                    <li class="nav-item <?php if (isset($_GET['q'])) {
                              ...
                              }  ?>"><a class="nav-link" href="<?php echo web_root; ?>index.php?q=Contact">Contact</a>
                    </li>
                    <?php if (!isset($_SESSION['APPLICANTID'])) { ?>
                    <li class="nav-item login"><a class="nav-link" data-target="#myModal" data-toggle="modal" href="">
                            <i class="fa fa-lock"></i> Login </a>
                    </li>

                    <?php } else { ?>

                    <li class="nav-item"><a class="nav-link" href="<?php echo web_root . 'applicant/'; ?>"><i
                                class="fa fa-user"></i><?php 
                                
                                  echo $appl->FNAME . ' ' . $appl->LNAME;
                              
                                ?></a></li>

                    <li class="nav-item"><a class="nav-link" href="<?php echo web_root . 'logout.php'; ?>"><i
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li><span class="icon icon-map-marker"></span><span class="text">559, avenue Al Boustane
                                        , Hay Riad, 10100 Rabat</span></li>
                                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+212 55 66 77
                                            88</span></a></li>
                                <li><a href="#"><span class="icon icon-envelope"></span><span
                                            class="text">Justfind@gmail.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
