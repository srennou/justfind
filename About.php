 ...
 <section class="ftco-about d-md-flex">
        ...
        <div>
  				<p>Just Find is maroc's leading online job portal. Job seekers can consult thousands of new employment ads every day, save interesting job ads, and send their applications directly on the website and/or with the mobile app. Just Find assists job seekers in their job search, thanks to various </p>
  			</div>
    	</div>
    </section>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">Jut Find is an ever-changing workplace, striving to innovate by bringing employers and candidates together. </p>
                    <p class="name">Houssam Safir</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">Each day, I’m inspired by my colleagues to drive innovation that accomplishes this. Jut Find fosters an environment of trust and support where I can drive customer success.</p>
                    <p class="name">Mohammed Sabir</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">We are dedicated to improving our clients’ lives as well as our own employees.</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-4">We are dedicated to improving our clients’ lives as well as our own employees
                      .</p>
                    <p class="name">Roger Scott</p>
